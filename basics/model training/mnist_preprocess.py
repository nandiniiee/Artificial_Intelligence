...
X_train = load_images("basics/model training/mnist_raw_dataset/train-images.idx3-ubyte")
y_train = load_labels("basics/model training/mnist_raw_dataset/train-labels.idx1-ubyte")
X_test = load_images("basics/model training/mnist_raw_dataset/t10k-images.idx3-ubyte")
y_test = load_labels("basics/model training/mnist_raw_dataset/t10k-labels.idx1-ubyte")
